function( EmbedDirectory directory ident )
    ...
    foreach( filename IN LISTS found_files )
        ...
        if( NOT "${dir}" STREQUAL "" )
            ...
            set_property( GLOBAL APPEND_STRING PROPERTY EMBED_DATA_${dir} "            static const uint8_t ${var}[] = { 0x${array} };\n" )
            set_property( GLOBAL APPEND_STRING PROPERTY EMBED_DATA_${dir} "            static const size_t  ${var}_l = ${bytes_size};\n" )
        else()
            set_property( GLOBAL APPEND_STRING PROPERTY EMBED_DATA "        static const uint8_t ${var}[] = { 0x${array} };\n" )
            set_property( GLOBAL APPEND_STRING PROPERTY EMBED_DATA "        static const size_t  ${var}_l = ${bytes_size};\n" )
        endif()
    endforeach()
endfunction()
